    ...
    <div className='flex *:rounded-none *:shadow-none max-xl:flex-col max-xl:*:not-last:border-b-0 max-xl:*:first:rounded-t-xl max-xl:*:last:rounded-b-xl xl:*:not-last:border-r-0 xl:*:first:rounded-l-xl xl:*:last:rounded-r-xl'>
      <Card className='overflow-hidden pt-0'>
        <CardContent className='px-0'>
          <img
            src='https://tomaslonnblad.github.io/m1.jpg?width=368&format=auto'
            alt='Banner'
      ...
      <Card className='overflow-hidden pt-0'>
        <CardContent className='px-0'>
          <img
            src='https://tomaslonnblad.github.io/m2.jpeg?width=368&format=auto'
            alt='Banner'
            className='aspect-video w-92 object-cover'
          />
        </CardContent>
      ...
      <Card className='overflow-hidden pt-0'>
        <CardContent className='px-0'>
          <img
            src='https://tomaslonnblad.github.io/m3.jpg?width=368&format=auto'
            alt='Banner'
            className='aspect-video w-92 object-cover'
          />
        </CardContent>
